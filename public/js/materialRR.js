$(function() {
    ...
    $("#mrDetailDelItem").click(function() {
        ...
        if (gr != null)
            jQuery("#requestDetailTable").jqGrid('delGridRow', gr, {reloadAfterSubmit: false});
        else
    ...
    $("#delReqeust").click(function() {
        var gr = jQuery("#requestTable").jqGrid('getGridParam', 'selrow');
        if (gr != null)
            jQuery("#requestTable").jqGrid('delGridRow', gr, {reloadAfterSubmit: false});
        else
            alert("Please Select Row to delete!");
    })
    ...
    $("#delReturn").click(function() {
        var gr = jQuery("#returnTable").jqGrid('getGridParam', 'selrow');
        if (gr != null)
            jQuery("#returnTable").jqGrid('delGridRow', gr, {reloadAfterSubmit: false});
        else
            alert("Please Select Row to delete!");
    })
