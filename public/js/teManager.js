$(function() {
    ...
    //輸出維修單
    $("#printRR").click(function() {
        //打開pdf輸出視窗
        var targetID = $(this).parent().find('#id').val();
        //alert(targetID);
        window.open(localhost + 'index.php/pdfOutput/index/rr/' + targetID,
                'Output Tools % Equipment Requistion', 'width=850,height=1200');
        ev.preventDefault();
        return false;
    });
    //輸出校準單
    $("#printRC").click(function() {
        ...
        var targetID = $(this).parent().find('#id').val();
        //alert(targetID);
        window.open(localhost + 'index.php/pdfOutput/index/rc/' + targetID,
                'Output Tools % Equipment Requistion', 'width=850,height=1200');
        ev.preventDefault();
        return false;
    });
    ...
    $("#printRD").click(function() {
        ...
        var targetID = $(this).parent().find('#id').val();
        //alert(targetID);
        window.open(localhost + 'index.php/pdfOutput/index/rd/' + targetID,
                'Output Tools % Equipment Requistion', 'width=850,height=1200');
        ev.preventDefault();
        return false;
    });
